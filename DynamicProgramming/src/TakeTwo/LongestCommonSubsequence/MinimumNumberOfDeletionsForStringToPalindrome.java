...
public class MinimumNumberOfDeletionsForStringToPalindrome {
    public static void main(String[] args) {
        String s1 = "agbcba";

        System.out.println("The minimum number of deletions to make the string a palindrome: "+findMinimumNumberOfDeletionsToMakeAPalindrome(s1));
